...
Two proven starting patterns, both taken near-verbatim from prompts that worked.
...
- **Jetpack Compose + Hilt** is the default stack across every app in the corpus (minSdk 28 was the observed floor; target SDK tracked current — 36 in the most recent projects). Room + sqlite-vec for anything needing local hybrid search/retrieval.
